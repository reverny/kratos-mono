...
import (
	...
	v1 "github.com/reverny/kratos-mono/gen/go/api/test/v1"
...
func NewHTTPServer(c *conf.Server, testSvc *service.TestService, logger log.Logger) *http.Server {
	...
	v1.RegisterTestHTTPServer(srv, testSvc)
