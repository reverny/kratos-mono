...
func NewHTTPServer(c *conf.Server, inventoryService *service.InventoryService, logger log.Logger) *http.Server {
	...
	v1.RegisterInventoryHTTPServer(srv, inventoryService)
